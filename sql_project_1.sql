...
-- Data Cleaning
-- Count the Retail_sales from the database
SELECT COUNT(*) FROM retail_sales;

-- Count the Unique customers from the Database
...
WHERE
	...
	AND 
	quantiy >= 4;  -- Total 17 Clothing are more than 4 and The month is Nov-2022
